...
import { 
  ...
  Plus, Minus, Trash2, CheckCircle2, ShoppingCart, Loader2, Zap, ScanLine
} from 'lucide-react'
...
export default function ScanPage() {
  ...
  if (loading) return <div className="h-screen bg-[#0a0f18] flex items-center justify-center text-blue-500 font-black italic uppercase tracking-tighter">Loading 1.1.0...</div>
